...
## إرسال موقع جغرافي | send_location.rb
...
send_location_message if __FILE__ == $PROGRAM_NAME
```

---

## إرسال جهة اتصال | send_contact.rb
...
send_contact_message if __FILE__ == $PROGRAM_NAME
```
